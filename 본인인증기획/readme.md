...
- 2가지 유형의 멤버 모두 채워진 항목하고 별개로 사용자 정보란에 unique한 id 값을 가지고 있음
  - 이 unique 한 id 값이 멤버의 기준이 됨
...
- **채널 멤버**는
  ...
  - (UCM2) goormedu 계정으로 로그인한 멤버의 경우 이전에 다른 채널에서 본인 인증을 완료한 경우 본인 인증을 하지 않아도 채널의 콘텐츠를 이용할 수 있다.
